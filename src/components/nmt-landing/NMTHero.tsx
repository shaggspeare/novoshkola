            ...
            <div className="row justify-content-between align-items-start">
               <div className="col-xl-5 col-lg-6">
                  <div className="banner__content">
                     <h1 className="title tg-svg" data-aos="fade-right" data-aos-delay="400" ref={svgIconRef}>
                        Підготовка до
                        <span className="position-relative nmt-hero-highlight" style={{ marginLeft: "10px" }}>
                        ...
                        <br />
                        за <b>ефективною</b> методикою
                     </h1>
                     <p data-aos="fade-right" data-aos-delay="600">
                        Групові та індивідуальні заняття з викладачами онлайн
                     </p>
                     ...
                     <p data-aos="fade-right"style={{ marginTop: "20px", fontSize: "14px", opacity: 0.8 }}>
