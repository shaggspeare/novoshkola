...
const instructor_nav_data: string[] = [
   "/assets/img/instructor/instructor_nav01.png",
   "/assets/img/instructor/instructor_nav02.png",
   "/assets/img/instructor/instructor_nav03.png",
   "/assets/img/instructor/instructor_nav04.png",
